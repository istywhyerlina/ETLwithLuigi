...
def extract_productdata(source, extract_path):
...
#html_data=f'./raw/{keyword}.html'    

#parsing(html_data,f'./raw/{keyword}.csv')
...
#buat tes
#transform_olx(f'./raw/{keyword}.csv',f'./result/{keyword}.csv')
...
# source=f'./raw/amazon_sales_data.csv'
# result=f'./result/amazon_sales_data.csv' 
...
# source=f'./raw/ElectronicsProductsPricingData.csv'
# result=f'./result/ElectronicsProductsPricingData.csv'
